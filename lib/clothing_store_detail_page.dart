...
class ClothingStoreDetailPage extends StatefulWidget {
  ...
  const ClothingStoreDetailPage(
      {Key key, this.imgString, this.price, this.title})
      : super(key: key);

  @override
  _ClothingStoreDetailPageState createState() =>
      _ClothingStoreDetailPageState();
}
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: NetworkImage(_img0), fit: BoxFit.cover),
                      ),
                    ),
                    Container(
                      decoration: BoxDecoration(
                            ...
                            Expanded(
                              child: Container(
                                decoration: BoxDecoration(
                                    ...
                                    borderRadius: BorderRadius.circular(8),
                                    image: DecorationImage(
                                        image: NetworkImage(_img0),
                                        fit: BoxFit.cover),
                                    border:
                                        _pageIndex == 0 ? Border.all() : null),
                              ),
                            ),
                            SizedBox(
                              width: 4,
